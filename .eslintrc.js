...
module.exports = {
    ...
    "rules": {
        ...
        "no-console": 1, // allow use of console (recommended for Node.js)
        ...
        "no-case-declarations": 1, // disallow lexical declarations in case clauses (recommended)
        ...
        "no-warning-comments": 0, // disallow usage of configurable warning terms in comments - e.g. _TODO or _FIXME
        ...
        "linebreak-style": 0, // allow mixed 'LF' and 'CRLF' as linebreaks
        ...
        "max-len": [2, 150, 2], // specify the maximum length of a line in your program
        ...
        "no-unneeded-ternary": 2, // allow the use of ternary operators when a simpler alternative exists
        ...
        "quotes": 0, // all alowed, specify whether backticks, double or single quotes should be used (fixable)
